...
| <a name="input_alarm_unhealthy_host_threshold"></a> [alarm\_unhealthy\_host\_threshold](#input\_alarm\_unhealthy\_host\_threshold) | Number of unhealthy hosts that triggers an alarm.<br/><br/>Recommended: Set to 1 for production environments to catch issues immediately.<br/>For development/staging, you might set higher or disable alarms entirely. | `number` | `1` | no |
...
| <a name="output_alarm_sns_topic_arn"></a> [alarm\_sns\_topic\_arn](#output\_alarm\_sns\_topic\_arn) | ARN of the SNS topic for ALB CloudWatch alarms (if created) |
