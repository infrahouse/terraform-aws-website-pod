...
| <a name="input_create_caa_records"></a> [create\_caa\_records](#input\_create\_caa\_records) | If True, create DNS records provided by var.dns\_a\_records. | `bool` | `true` | no |
